...
```{r}
Unc_Conts<-read_csv("Data_Cilantro_Outputs/Water_Testing_Analysis_R3.csv")
```
...
ggsave("Contamination vs Method-R3.jpeg", width = 15, height = 10, units = "cm", dpi = 600)
```

```{r}
Conts_WT = Unc_Conts[1:150,2]
...
ggsave("Contamination vs Method Differences Water-R3.jpeg", width = 15, height = 10, units = "cm", dpi = 600)
...
```{r}
Unc_Conts<-read_csv("Data_Cilantro_Outputs/Product_Testing_Analysis_R3.csv")
...
ggsave("Contamination vs Field Contam-R3.jpeg", width = 15, height = 10, units = "cm", dpi = 600)

...
Fig2 <- ggplot(BS2, aes(fill=Contamination, x=Scenarios2, y=Relative_Efficacy)) + 
  geom_bar(position = "dodge", stat = "identity") + 
  labs(title="Contamination Frequency 2: Sporadic, irrigation with contaminated water\n  once per season", y="Relative Efficacy: Endpoint Oocyst", x="Sampling Scenario")
